        ...
        this.eventSource.on('command', (cmd) => {
          ...
          if (cmd.method === 'turn_on') {
            if (cmd.params[0].data.custom) {
              this.state.custom.powerState = true;
              cmd.success({
                custom: {
                  powerState: true
                }
          ...
          if (cmd.method === 'turn_off') {
            if (cmd.params[0].data.custom) {
              this.state.custom.powerState = false;
              cmd.success({
                custom: {
                  powerState: false
                }
          ...
          if (cmd.method === 'toggle_power') {
            this.state.custom.powerState = !this.state.custom.powerState;
            cmd.success({
              custom: {
                powerState: this.state.custom.powerState
              }
            });
          }
